...
export const getMedicationData = (
  ...
  const dataSet =
    predictionType === "weekly"
      ? weeklyMedicationDataSets
      : monthlyMedicationDataSets;
...
// Transform medications to Firebase format
export const firebaseMedications = medications.map((med) => ({
  medicationId: med.id,
  name: med.name,
  category: med.category,
  description: med.description,
  createdAt: "2025-07-19T12:00:00Z", // or use new Date().toISOString()
  isActive: true,
}));
